# Run CV Upgrade Fields Migration Script
# This script runs the SQL migration to add CV upgrade fields

Write-Host "Running CV Upgrade Fields Migration..." -ForegroundColor Cyan

$connectionString = "Server=Haidar;Database=CodeWaveDatabase;Trusted_Connection=True;TrustServerCertificate=True;"
$sqlScript = Get-Content -Path "CodeWave.Infrastructure\Migrations\AddCVUpgradeFields.sql" -Raw
