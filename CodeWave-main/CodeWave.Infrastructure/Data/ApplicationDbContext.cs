...
namespace CodeWave.Infrastructure.Data
{
        ...
        : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>
    {
        ...
        public DbSet<UserInterviewPractice> UserInterviewPractices { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // ==============================
            builder.Entity<ExternalJobApplication>(entity =>
            {
                entity.Property(e => e.ExternalJobId).IsRequired().HasMaxLength(500);
                entity.Property(e => e.JobTitle).IsRequired().HasMaxLength(300);
                entity.Property(e => e.EmployerName).IsRequired().HasMaxLength(200);
                entity.Property(e => e.EmployerLogo).IsRequired(false);
                entity.Property(e => e.JobLocation).IsRequired(false);
                entity.Property(e => e.ApplyLink).IsRequired().HasMaxLength(2000);
            ...
            builder.Entity<Achievement>(entity =>
            {
                ...
                entity.Property(a => a.GradientFrom).HasMaxLength(20);
                entity.Property(a => a.GradientTo).HasMaxLength(20);
            ...
            {
                entity.Property(q => q.Question).HasMaxLength(1000);
                entity.Property(q => q.Category).HasMaxLength(100);
                entity.Property(q => q.Difficulty).HasMaxLength(50);
                entity.Property(q => q.Tags).HasMaxLength(300);
            });

            builder.Entity<UserInterviewPractice>(entity =>
            {
                entity.HasIndex(p => new { p.UserId, p.QuestionId }).IsUnique();

                entity.HasOne(p => p.Question)
                    .WithMany(q => q.Practices)
