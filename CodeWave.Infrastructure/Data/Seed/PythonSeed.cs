...
with open(""output.txt"", ""w"") as f:
    f.write(""Hello, World!"")</code></pre>
        ...
        private static async Task SeedPythonQuizzesAsync(ApplicationDbContext context, Guid courseId)
        {
            ...
            // Quiz 4: Python OOP Quiz
            var quiz4Id = Guid.Parse("f4444444-4444-4444-4444-444444444444");
            ...
            if (quiz4 == null)
            {
                quiz4 = new Quiz
                {
                    ...
                    Description = "Test your understanding of classes, inheritance, and object-oriented design in Python",
                    TimeLimitMinutes = 20,
                    PassingScore = 70,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                ...
                var po1 = new QuizQuestion { Id = Guid.Parse("fe444441-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "Which method is called automatically when a Python object is created?", Difficulty = "Easy", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(po1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa444411-4444-4444-4444-444444444444"), QuizQuestionId = po1.Id, Text = "__start__", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444412-4444-4444-4444-444444444444"), QuizQuestionId = po1.Id, Text = "__init__", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444413-4444-4444-4444-444444444444"), QuizQuestionId = po1.Id, Text = "__new__", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444414-4444-4444-4444-444444444444"), QuizQuestionId = po1.Id, Text = "__create__", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var po2 = new QuizQuestion { Id = Guid.Parse("fe444442-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "How do you inherit from a parent class in Python?", Difficulty = "Easy", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(po2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa444421-4444-4444-4444-444444444444"), QuizQuestionId = po2.Id, Text = "class Child extends Parent:", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444422-4444-4444-4444-444444444444"), QuizQuestionId = po2.Id, Text = "class Child(Parent):", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444423-4444-4444-4444-444444444444"), QuizQuestionId = po2.Id, Text = "class Child inherits Parent:", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444424-4444-4444-4444-444444444444"), QuizQuestionId = po2.Id, Text = "class Child : Parent:", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var po3 = new QuizQuestion { Id = Guid.Parse("fe444443-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "What does `self` refer to in a Python class method?", Difficulty = "Easy", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(po3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa444431-4444-4444-4444-444444444444"), QuizQuestionId = po3.Id, Text = "The class itself", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444432-4444-4444-4444-444444444444"), QuizQuestionId = po3.Id, Text = "The current instance", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444433-4444-4444-4444-444444444444"), QuizQuestionId = po3.Id, Text = "A global variable", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444434-4444-4444-4444-444444444444"), QuizQuestionId = po3.Id, Text = "The parent class", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var po4 = new QuizQuestion { Id = Guid.Parse("fe444444-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "Which decorator creates a class method that receives the class as first argument?", Difficulty = "Medium", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(po4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa444441-4444-4444-4444-444444444444"), QuizQuestionId = po4.Id, Text = "@staticmethod", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444442-4444-4444-4444-444444444444"), QuizQuestionId = po4.Id, Text = "@classmethod", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444443-4444-4444-4444-444444444444"), QuizQuestionId = po4.Id, Text = "@property", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444444-4444-4444-4444-444444444444"), QuizQuestionId = po4.Id, Text = "@instance", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var po5 = new QuizQuestion { Id = Guid.Parse("fe444445-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "What is the output of: `print(isinstance(True, int))`?", Difficulty = "Hard", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(po5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa444451-4444-4444-4444-444444444444"), QuizQuestionId = po5.Id, Text = "False", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444452-4444-4444-4444-444444444444"), QuizQuestionId = po5.Id, Text = "True", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444453-4444-4444-4444-444444444444"), QuizQuestionId = po5.Id, Text = "None", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa444454-4444-4444-4444-444444444444"), QuizQuestionId = po5.Id, Text = "TypeError", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                await context.SaveChangesAsync();
            }

            // Quiz 5: Python Advanced Topics Quiz
            var quiz5Id = Guid.Parse("f5555555-5555-5555-5555-555555555555");
            ...
            if (quiz5 == null)
            {
                quiz5 = new Quiz
                {
                    ...
                    Description = "Decorators, generators, comprehensions, and advanced Python features",
                    TimeLimitMinutes = 25,
                    PassingScore = 75,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                ...
                var pa1 = new QuizQuestion { Id = Guid.Parse("fe555551-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "What does a generator function use instead of `return`?", Difficulty = "Medium", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pa1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa555511-5555-5555-5555-555555555555"), QuizQuestionId = pa1.Id, Text = "emit", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555512-5555-5555-5555-555555555555"), QuizQuestionId = pa1.Id, Text = "yield", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555513-5555-5555-5555-555555555555"), QuizQuestionId = pa1.Id, Text = "produce", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555514-5555-5555-5555-555555555555"), QuizQuestionId = pa1.Id, Text = "send", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pa2 = new QuizQuestion { Id = Guid.Parse("fe555552-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "What is the result of `[x*2 for x in range(3)]`?", Difficulty = "Easy", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pa2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa555521-5555-5555-5555-555555555555"), QuizQuestionId = pa2.Id, Text = "[0, 2, 4]", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555522-5555-5555-5555-555555555555"), QuizQuestionId = pa2.Id, Text = "[2, 4, 6]", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555523-5555-5555-5555-555555555555"), QuizQuestionId = pa2.Id, Text = "[1, 2, 3]", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555524-5555-5555-5555-555555555555"), QuizQuestionId = pa2.Id, Text = "[0, 1, 2]", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pa3 = new QuizQuestion { Id = Guid.Parse("fe555553-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "What does the `*args` parameter allow in a Python function?", Difficulty = "Medium", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pa3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa555531-5555-5555-5555-555555555555"), QuizQuestionId = pa3.Id, Text = "Only keyword arguments", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555532-5555-5555-5555-555555555555"), QuizQuestionId = pa3.Id, Text = "A variable number of positional arguments", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555533-5555-5555-5555-555555555555"), QuizQuestionId = pa3.Id, Text = "Exactly two arguments", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555534-5555-5555-5555-555555555555"), QuizQuestionId = pa3.Id, Text = "No arguments", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pa4 = new QuizQuestion { Id = Guid.Parse("fe555554-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "Which built-in function is used to open a file in Python?", Difficulty = "Easy", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pa4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa555541-5555-5555-5555-555555555555"), QuizQuestionId = pa4.Id, Text = "read()", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555542-5555-5555-5555-555555555555"), QuizQuestionId = pa4.Id, Text = "open()", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555543-5555-5555-5555-555555555555"), QuizQuestionId = pa4.Id, Text = "file()", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555544-5555-5555-5555-555555555555"), QuizQuestionId = pa4.Id, Text = "load()", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pa5 = new QuizQuestion { Id = Guid.Parse("fe555555-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "What does `lambda x: x ** 2` create?", Difficulty = "Medium", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pa5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa555551-5555-5555-5555-555555555555"), QuizQuestionId = pa5.Id, Text = "A named function that squares x", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555552-5555-5555-5555-555555555555"), QuizQuestionId = pa5.Id, Text = "An anonymous function that squares x", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555553-5555-5555-5555-555555555555"), QuizQuestionId = pa5.Id, Text = "A class with a square method", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa555554-5555-5555-5555-555555555555"), QuizQuestionId = pa5.Id, Text = "A decorator for squaring", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                await context.SaveChangesAsync();
            }

            // Quiz 6: Python File I/O & Modules Quiz
            var quiz6Id = Guid.Parse("f6666666-6666-6666-6666-666666666666");
            ...
            if (quiz6 == null)
            {
                quiz6 = new Quiz
                {
                    Id = quiz6Id,
                    CourseId = courseId,
                    Title = "Python File I/O & Modules Quiz",
                    Description = "Test your knowledge of file handling, modules, packages, and the Python standard library",
                    TimeLimitMinutes = 20,
                    PassingScore = 70,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                ...
                var pf1 = new QuizQuestion { Id = Guid.Parse("fe666661-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "Which mode opens a file for writing and creates it if it doesn't exist?", Difficulty = "Easy", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pf1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa666611-6666-6666-6666-666666666666"), QuizQuestionId = pf1.Id, Text = "\"r\"", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666612-6666-6666-6666-666666666666"), QuizQuestionId = pf1.Id, Text = "\"w\"", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666613-6666-6666-6666-666666666666"), QuizQuestionId = pf1.Id, Text = "\"x\"", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666614-6666-6666-6666-666666666666"), QuizQuestionId = pf1.Id, Text = "\"a\"", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pf2 = new QuizQuestion { Id = Guid.Parse("fe666662-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What is the correct way to import only the `sqrt` function from the `math` module?", Difficulty = "Easy", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pf2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa666621-6666-6666-6666-666666666666"), QuizQuestionId = pf2.Id, Text = "import math.sqrt", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666622-6666-6666-6666-666666666666"), QuizQuestionId = pf2.Id, Text = "from math import sqrt", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666623-6666-6666-6666-666666666666"), QuizQuestionId = pf2.Id, Text = "include math.sqrt", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666624-6666-6666-6666-666666666666"), QuizQuestionId = pf2.Id, Text = "using math import sqrt", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pf3 = new QuizQuestion { Id = Guid.Parse("fe666663-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What does the `with` statement guarantee when working with files?", Difficulty = "Medium", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pf3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa666631-6666-6666-6666-666666666666"), QuizQuestionId = pf3.Id, Text = "The file is read line by line", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666632-6666-6666-6666-666666666666"), QuizQuestionId = pf3.Id, Text = "The file is automatically closed after the block", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666633-6666-6666-6666-666666666666"), QuizQuestionId = pf3.Id, Text = "The file is opened in binary mode", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666634-6666-6666-6666-666666666666"), QuizQuestionId = pf3.Id, Text = "The file cannot be modified", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pf4 = new QuizQuestion { Id = Guid.Parse("fe666664-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "Which module provides tools for working with dates and times in Python?", Difficulty = "Easy", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pf4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa666641-6666-6666-6666-666666666666"), QuizQuestionId = pf4.Id, Text = "time_utils", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666642-6666-6666-6666-666666666666"), QuizQuestionId = pf4.Id, Text = "datetime", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666643-6666-6666-6666-666666666666"), QuizQuestionId = pf4.Id, Text = "calendar_lib", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666644-6666-6666-6666-666666666666"), QuizQuestionId = pf4.Id, Text = "clock", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var pf5 = new QuizQuestion { Id = Guid.Parse("fe666665-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What file is required to make a Python directory a package?", Difficulty = "Medium", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(pf5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("fa666651-6666-6666-6666-666666666666"), QuizQuestionId = pf5.Id, Text = "main.py", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666652-6666-6666-6666-666666666666"), QuizQuestionId = pf5.Id, Text = "__init__.py", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666653-6666-6666-6666-666666666666"), QuizQuestionId = pf5.Id, Text = "setup.py", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("fa666654-6666-6666-6666-666666666666"), QuizQuestionId = pf5.Id, Text = "package.py", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });
