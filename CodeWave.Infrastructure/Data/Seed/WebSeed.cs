...
namespace CodeWave.Infrastructure.Data.Seed
{
    public static class WebSeed
    {
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            var intermediateCourseId = Guid.Parse(intermediateIdStr);
            var advancedCourseId     = Guid.Parse(advancedIdStr);
            ...
            await context.Database.ExecuteSqlRawAsync($@"
                ...
                IF NOT EXISTS (SELECT 1 FROM Courses WHERE Id = '{beginnerIdStr}')
                    ...
                    VALUES ('{beginnerIdStr}','Web Development — Beginner',
                        'Learn the foundations: HTML structure, CSS styling, and JavaScript basics.',
                        'Beginner','Web Development','2024-01-01',0,2)
                ELSE
                    UPDATE Courses SET Title='Web Development — Beginner',DifficultyLevel='Beginner',
                        LearningPath='Web Development',IsDeleted=0,ProgrammingLanguage=2,CreatedAt='2024-01-01'
                    WHERE Id='{beginnerIdStr}';

                IF NOT EXISTS (SELECT 1 FROM Courses WHERE Id = '{intermediateIdStr}')
                    INSERT INTO Courses (Id,Title,Description,DifficultyLevel,LearningPath,CreatedAt,IsDeleted,ProgrammingLanguage)
                    VALUES ('{intermediateIdStr}','Web Development — Intermediate',
                        'Level up with CSS Grid, animations, ES6+, Fetch API, and async JavaScript.',
                        'Intermediate','Web Development','2024-01-02',0,2)
                ELSE
                    UPDATE Courses SET Title='Web Development — Intermediate',DifficultyLevel='Intermediate',
                        LearningPath='Web Development',IsDeleted=0,ProgrammingLanguage=2,CreatedAt='2024-01-02'
                    WHERE Id='{intermediateIdStr}';

                IF NOT EXISTS (SELECT 1 FROM Courses WHERE Id = '{advancedIdStr}')
                    INSERT INTO Courses (Id,Title,Description,DifficultyLevel,LearningPath,CreatedAt,IsDeleted,ProgrammingLanguage)
                    VALUES ('{advancedIdStr}','Web Development — Advanced',
                        'Master JS modules, Node.js, React, REST APIs, authentication, and deployment.',
                        'Advanced','Web Development','2024-01-03',0,2)
                ELSE
                    UPDATE Courses SET Title='Web Development — Advanced',DifficultyLevel='Advanced',
                        LearningPath='Web Development',IsDeleted=0,ProgrammingLanguage=2,CreatedAt='2024-01-03'
                    WHERE Id='{advancedIdStr}';
            ");
...
title.classList.toggle(""active"");</code></pre>
  ...
  console.log(""clicked!"");
            ...
            {
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000001"), CourseId=intermediateCourseId,
                    Title="Advanced HTML5 and Semantic Elements", OrderNumber=1,
...
&lt;li data-id=""42"" data-category=""web""&gt;Item&lt;/li&gt;</code></pre>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000002"), CourseId=intermediateCourseId,
                    Title="CSS Grid Layout", OrderNumber=2,
...
.tall { grid-row: span 2; }</code></pre>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000003"), CourseId=intermediateCourseId,
                    Title="CSS Animations and Transitions", OrderNumber=3,
...
.ball { animation: bounce 1s ease infinite; }</code></pre>
  ...
  <pre class=""bg-slate-900/80 border border-slate-700 rounded-xl p-4 text-xs overflow-x-auto""><code>.box { transform: rotate(45deg) scale(1.2) translateX(20px); }</code></pre>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000004"), CourseId=intermediateCourseId,
                    Title="Responsive Design with Media Queries", OrderNumber=4,
...
@media (min-width: 1024px) { .card { width: 33%; } }   /* desktop */</code></pre>
  ...
  <ul class=""list-disc list-inside space-y-1"">
    ...
    <li><strong class=""text-cyan-300"">%</strong> — relative to parent element</li>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000005"), CourseId=intermediateCourseId,
                    Title="JavaScript ES6+ Modern Features", OrderNumber=5,
                    ImageUrl="https://images.unsplash.com/photo-1579468118864-1b9ea3c0db4a?auto=format&fit=crop&w=800&q=80",
...
function sum(...nums) { return nums.reduce((a,b)=>a+b,0); }</code></pre>
  ...
  <pre class=""bg-slate-900/80 border border-slate-700 rounded-xl p-4 text-xs overflow-x-auto""><code>const city = user?.address?.city ?? ""Unknown"";</code></pre>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000006"), CourseId=intermediateCourseId,
                    Title="Arrays — map, filter, reduce", OrderNumber=6,
                    ImageUrl="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=800&q=80",
...
const idx    = nums.indexOf(3);        // 2</code></pre>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000007"), CourseId=intermediateCourseId,
                    Title="JavaScript Objects and JSON", OrderNumber=7,
...
// back to a JS object</code></pre>
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000008"), CourseId=intermediateCourseId,
                    Title="The Fetch API and Promises", OrderNumber=8,
  ...
  body: JSON.stringify({ name: ""Alice"" })
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000009"), CourseId=intermediateCourseId,
                    Title="Async/Await and Error Handling", OrderNumber=9,
                    ImageUrl="https://images.unsplash.com/photo-1593720219276-0b1eacd0aef4?auto=format&fit=crop&w=800&q=80",
  ...
  fetch(""/api/posts"").then(r=>r.json())
                ...
                new Lesson { Id=Guid.Parse("a1200000-0000-0000-0000-000000000010"), CourseId=intermediateCourseId,
                    Title="Browser Storage and Web APIs", OrderNumber=10,
...
navigator.geolocation.getCurrentPosition(pos => {
  console.log(pos.coords.latitude, pos.coords.longitude);
            ...
            {
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000001"), CourseId=advancedCourseId,
                    Title="JavaScript Modules (ESM)", OrderNumber=1,
...
log(""App started"");</code></pre>
  ...
  <pre class=""bg-slate-900/80 border border-slate-700 rounded-xl p-4 text-xs overflow-x-auto""><code>const { add } = await import(""./math.js""); // lazy load</code></pre>
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000002"), CourseId=advancedCourseId,
                    Title="Introduction to Node.js", OrderNumber=2,
                    ImageUrl="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=800&q=80",
...
server.listen(3000, () => console.log(""Listening on 3000""));</code></pre>
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000003"), CourseId=advancedCourseId,
                    Title="NPM and Package Management", OrderNumber=3,
...
npm run build          # run a script</code></pre>
  ...
  ""devDependencies"": { ""vite"":  ""^5.0.0"" }
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000004"), CourseId=advancedCourseId,
                    Title="Introduction to React", OrderNumber=4,
...
export default App;</code></pre>
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000005"), CourseId=advancedCourseId,
                    Title="React Components, Props and Composition", OrderNumber=5,
...
&lt;Card title=""React"" description=""A UI library"" imageUrl=""/react.png"" /&gt;</code></pre>
  ...
  return &lt;main className=""layout""&gt;{children}&lt;/main&gt;;
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000006"), CourseId=advancedCourseId,
                    Title="React State and Hooks", OrderNumber=6,
...
useEffect(() => {
  document.title = `Count: ${count}`;
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000007"), CourseId=advancedCourseId,
                    Title="REST API Design and Integration", OrderNumber=7,
...
await fetch(""/api/users/42"", { method:""DELETE"" });</code></pre>
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000008"), CourseId=advancedCourseId,
                    Title="Authentication — JWT and Sessions", OrderNumber=8,
                    ImageUrl="https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=800&q=80",
...
fetch(""/api/profile"", {
  ...
  <p class=""text-slate-300"">Store tokens in httpOnly cookies (not localStorage) to protect against XSS attacks.</p>
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000009"), CourseId=advancedCourseId,
                    Title="Web Performance Optimization", OrderNumber=9,
...
const Dashboard = React.lazy(() => import(""./Dashboard""));</code></pre>
                ...
                new Lesson { Id=Guid.Parse("b1300000-0000-0000-0000-000000000010"), CourseId=advancedCourseId,
                    Title="Deploying Web Applications", OrderNumber=10,
                    ImageUrl="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=800&q=80",
...
const api = import.meta.env.VITE_API_URL;</code></pre>
            ...
            await SeedWebQuizzesAsync(context, beginnerCourseId, intermediateCourseId, advancedCourseId);
        }
