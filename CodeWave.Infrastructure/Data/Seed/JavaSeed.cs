...
else
{
    ...
    tc2.IsDeleted = true; // merged into tc1; redundant with empty input
        ...
        private static async Task SeedJavaQuizzesAsync(ApplicationDbContext context, Guid courseId)
        {
            ...
            // Quiz 3: Java Collections & Generics Quiz
            var quiz3Id = Guid.Parse("a3333333-3333-3333-3333-333333333333");
            ...
            if (quiz3 == null)
            {
                quiz3 = new Quiz
                {
                    ...
                    Description = "Test your knowledge of Java Collections Framework, Lists, Maps, and Sets",
                    TimeLimitMinutes = 20,
                    PassingScore = 70,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                ...
                var jc1 = new QuizQuestion { Id = Guid.Parse("a9333331-3333-3333-3333-333333333333"), QuizId = quiz3Id, Text = "Which interface does ArrayList implement?", Difficulty = "Easy", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jc1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa333311-3333-3333-3333-333333333333"), QuizQuestionId = jc1.Id, Text = "List", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333312-3333-3333-3333-333333333333"), QuizQuestionId = jc1.Id, Text = "Map", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333313-3333-3333-3333-333333333333"), QuizQuestionId = jc1.Id, Text = "Set", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333314-3333-3333-3333-333333333333"), QuizQuestionId = jc1.Id, Text = "Queue", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jc2 = new QuizQuestion { Id = Guid.Parse("a9333332-3333-3333-3333-333333333333"), QuizId = quiz3Id, Text = "Which collection does NOT allow duplicate values?", Difficulty = "Easy", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jc2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa333321-3333-3333-3333-333333333333"), QuizQuestionId = jc2.Id, Text = "ArrayList", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333322-3333-3333-3333-333333333333"), QuizQuestionId = jc2.Id, Text = "LinkedList", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333323-3333-3333-3333-333333333333"), QuizQuestionId = jc2.Id, Text = "HashSet", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333324-3333-3333-3333-333333333333"), QuizQuestionId = jc2.Id, Text = "Vector", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jc3 = new QuizQuestion { Id = Guid.Parse("a9333333-3333-3333-3333-333333333333"), QuizId = quiz3Id, Text = "What does HashMap store?", Difficulty = "Easy", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jc3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa333331-3333-3333-3333-333333333333"), QuizQuestionId = jc3.Id, Text = "Key-value pairs", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333332-3333-3333-3333-333333333333"), QuizQuestionId = jc3.Id, Text = "Only values", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333333-3333-3333-3333-333333333333"), QuizQuestionId = jc3.Id, Text = "Only keys", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333334-3333-3333-3333-333333333333"), QuizQuestionId = jc3.Id, Text = "Sorted elements", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jc4 = new QuizQuestion { Id = Guid.Parse("a9333334-3333-3333-3333-333333333333"), QuizId = quiz3Id, Text = "Which method removes an element by index from an ArrayList?", Difficulty = "Medium", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jc4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa333341-3333-3333-3333-333333333333"), QuizQuestionId = jc4.Id, Text = "delete(index)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333342-3333-3333-3333-333333333333"), QuizQuestionId = jc4.Id, Text = "remove(index)", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333343-3333-3333-3333-333333333333"), QuizQuestionId = jc4.Id, Text = "erase(index)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333344-3333-3333-3333-333333333333"), QuizQuestionId = jc4.Id, Text = "pop(index)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jc5 = new QuizQuestion { Id = Guid.Parse("a9333335-3333-3333-3333-333333333333"), QuizId = quiz3Id, Text = "What is the time complexity of HashMap.get()?", Difficulty = "Hard", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jc5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa333351-3333-3333-3333-333333333333"), QuizQuestionId = jc5.Id, Text = "O(log n)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333352-3333-3333-3333-333333333333"), QuizQuestionId = jc5.Id, Text = "O(1) average", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333353-3333-3333-3333-333333333333"), QuizQuestionId = jc5.Id, Text = "O(n)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa333354-3333-3333-3333-333333333333"), QuizQuestionId = jc5.Id, Text = "O(n²)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                await context.SaveChangesAsync();
            }

            // Quiz 4: Java Exception Handling Quiz
            var quiz4Id = Guid.Parse("a4444444-4444-4444-4444-444444444444");
            var quiz4 = await context.Quizzes.FirstOrDefaultAsync(q => q.Id == quiz4Id);
            if (quiz4 == null)
            {
                quiz4 = new Quiz
                {
                    Id = quiz4Id,
                    CourseId = courseId,
                    Title = "Java Exception Handling Quiz",
                    Description = "Master try-catch-finally, checked vs unchecked exceptions, and custom exceptions",
                    TimeLimitMinutes = 15,
                    PassingScore = 70,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                };
                await context.Quizzes.AddAsync(quiz4);
                await context.SaveChangesAsync();

                var je1 = new QuizQuestion { Id = Guid.Parse("a9444441-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "Which block always executes in a try-catch-finally statement?", Difficulty = "Easy", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(je1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa444411-4444-4444-4444-444444444444"), QuizQuestionId = je1.Id, Text = "try", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444412-4444-4444-4444-444444444444"), QuizQuestionId = je1.Id, Text = "catch", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444413-4444-4444-4444-444444444444"), QuizQuestionId = je1.Id, Text = "finally", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444414-4444-4444-4444-444444444444"), QuizQuestionId = je1.Id, Text = "throw", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var je2 = new QuizQuestion { Id = Guid.Parse("a9444442-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "Which is a checked exception in Java?", Difficulty = "Medium", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(je2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa444421-4444-4444-4444-444444444444"), QuizQuestionId = je2.Id, Text = "NullPointerException", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444422-4444-4444-4444-444444444444"), QuizQuestionId = je2.Id, Text = "IOException", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444423-4444-4444-4444-444444444444"), QuizQuestionId = je2.Id, Text = "ArrayIndexOutOfBoundsException", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444424-4444-4444-4444-444444444444"), QuizQuestionId = je2.Id, Text = "ClassCastException", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var je3 = new QuizQuestion { Id = Guid.Parse("a9444443-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "Which keyword is used to manually throw an exception?", Difficulty = "Easy", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(je3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa444431-4444-4444-4444-444444444444"), QuizQuestionId = je3.Id, Text = "throws", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444432-4444-4444-4444-444444444444"), QuizQuestionId = je3.Id, Text = "throw", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444433-4444-4444-4444-444444444444"), QuizQuestionId = je3.Id, Text = "raise", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444434-4444-4444-4444-444444444444"), QuizQuestionId = je3.Id, Text = "error", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var je4 = new QuizQuestion { Id = Guid.Parse("a9444444-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "What is the parent class of all exceptions in Java?", Difficulty = "Medium", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(je4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa444441-4444-4444-4444-444444444444"), QuizQuestionId = je4.Id, Text = "Error", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444442-4444-4444-4444-444444444444"), QuizQuestionId = je4.Id, Text = "RuntimeException", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444443-4444-4444-4444-444444444444"), QuizQuestionId = je4.Id, Text = "Throwable", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444444-4444-4444-4444-444444444444"), QuizQuestionId = je4.Id, Text = "Exception", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var je5 = new QuizQuestion { Id = Guid.Parse("a9444445-4444-4444-4444-444444444444"), QuizId = quiz4Id, Text = "A custom exception should extend which class for unchecked behavior?", Difficulty = "Hard", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(je5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa444451-4444-4444-4444-444444444444"), QuizQuestionId = je5.Id, Text = "Exception", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444452-4444-4444-4444-444444444444"), QuizQuestionId = je5.Id, Text = "Throwable", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444453-4444-4444-4444-444444444444"), QuizQuestionId = je5.Id, Text = "RuntimeException", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa444454-4444-4444-4444-444444444444"), QuizQuestionId = je5.Id, Text = "Error", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                await context.SaveChangesAsync();
            }

            // Quiz 5: Java Multithreading Quiz
            var quiz5Id = Guid.Parse("a5555555-5555-5555-5555-555555555555");
            var quiz5 = await context.Quizzes.FirstOrDefaultAsync(q => q.Id == quiz5Id);
            if (quiz5 == null)
            {
                quiz5 = new Quiz
                {
                    ...
                    Description = "Test your knowledge of threads, synchronization, and concurrency in Java",
                    TimeLimitMinutes = 20,
                    PassingScore = 70,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                };
                await context.Quizzes.AddAsync(quiz5);
                await context.SaveChangesAsync();

                var jt1 = new QuizQuestion { Id = Guid.Parse("a9555551-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "Which interface must a class implement to be used as a thread task?", Difficulty = "Easy", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jt1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa555511-5555-5555-5555-555555555555"), QuizQuestionId = jt1.Id, Text = "Runnable", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555512-5555-5555-5555-555555555555"), QuizQuestionId = jt1.Id, Text = "Callable", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555513-5555-5555-5555-555555555555"), QuizQuestionId = jt1.Id, Text = "Executable", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555514-5555-5555-5555-555555555555"), QuizQuestionId = jt1.Id, Text = "Threadable", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jt2 = new QuizQuestion { Id = Guid.Parse("a9555552-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "Which method starts a thread's execution?", Difficulty = "Easy", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jt2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa555521-5555-5555-5555-555555555555"), QuizQuestionId = jt2.Id, Text = "run()", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555522-5555-5555-5555-555555555555"), QuizQuestionId = jt2.Id, Text = "begin()", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555523-5555-5555-5555-555555555555"), QuizQuestionId = jt2.Id, Text = "start()", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555524-5555-5555-5555-555555555555"), QuizQuestionId = jt2.Id, Text = "execute()", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jt3 = new QuizQuestion { Id = Guid.Parse("a9555553-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "Which keyword makes a method accessible by only one thread at a time?", Difficulty = "Medium", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jt3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa555531-5555-5555-5555-555555555555"), QuizQuestionId = jt3.Id, Text = "volatile", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555532-5555-5555-5555-555555555555"), QuizQuestionId = jt3.Id, Text = "synchronized", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555533-5555-5555-5555-555555555555"), QuizQuestionId = jt3.Id, Text = "atomic", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555534-5555-5555-5555-555555555555"), QuizQuestionId = jt3.Id, Text = "locked", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jt4 = new QuizQuestion { Id = Guid.Parse("a9555554-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "What happens when two threads wait for each other's locked resources?", Difficulty = "Medium", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jt4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa555541-5555-5555-5555-555555555555"), QuizQuestionId = jt4.Id, Text = "Race condition", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555542-5555-5555-5555-555555555555"), QuizQuestionId = jt4.Id, Text = "Deadlock", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555543-5555-5555-5555-555555555555"), QuizQuestionId = jt4.Id, Text = "Starvation", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555544-5555-5555-5555-555555555555"), QuizQuestionId = jt4.Id, Text = "Livelock", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jt5 = new QuizQuestion { Id = Guid.Parse("a9555555-5555-5555-5555-555555555555"), QuizId = quiz5Id, Text = "Which class from java.util.concurrent manages a pool of worker threads?", Difficulty = "Hard", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jt5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa555551-5555-5555-5555-555555555555"), QuizQuestionId = jt5.Id, Text = "ThreadGroup", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555552-5555-5555-5555-555555555555"), QuizQuestionId = jt5.Id, Text = "ExecutorService", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555553-5555-5555-5555-555555555555"), QuizQuestionId = jt5.Id, Text = "ThreadFactory", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa555554-5555-5555-5555-555555555555"), QuizQuestionId = jt5.Id, Text = "ForkJoinPool", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                await context.SaveChangesAsync();
            }

            // Quiz 6: Java Algorithms & Problem Solving Quiz
            var quiz6Id = Guid.Parse("a6666666-6666-6666-6666-666666666666");
            var quiz6 = await context.Quizzes.FirstOrDefaultAsync(q => q.Id == quiz6Id);
            if (quiz6 == null)
            {
                quiz6 = new Quiz
                {
                    Id = quiz6Id,
                    CourseId = courseId,
                    Title = "Java Algorithms & Problem Solving Quiz",
                    Description = "Big-O complexity, sorting algorithms, recursion, and common Java problem-solving patterns",
                    TimeLimitMinutes = 25,
                    PassingScore = 70,
                    CreatedAt = DateTime.UtcNow,
                    IsDeleted = false
                };
                await context.Quizzes.AddAsync(quiz6);
                await context.SaveChangesAsync();

                var jal1 = new QuizQuestion { Id = Guid.Parse("a9666661-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What is the time complexity of binary search?", Difficulty = "Medium", OrderNumber = 1, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jal1);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa666611-6666-6666-6666-666666666666"), QuizQuestionId = jal1.Id, Text = "O(n)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666612-6666-6666-6666-666666666666"), QuizQuestionId = jal1.Id, Text = "O(log n)", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666613-6666-6666-6666-666666666666"), QuizQuestionId = jal1.Id, Text = "O(n²)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666614-6666-6666-6666-666666666666"), QuizQuestionId = jal1.Id, Text = "O(1)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jal2 = new QuizQuestion { Id = Guid.Parse("a9666662-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "Which sorting algorithm has the best average-case time complexity?", Difficulty = "Medium", OrderNumber = 2, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jal2);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa666621-6666-6666-6666-666666666666"), QuizQuestionId = jal2.Id, Text = "Bubble Sort", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666622-6666-6666-6666-666666666666"), QuizQuestionId = jal2.Id, Text = "Selection Sort", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666623-6666-6666-6666-666666666666"), QuizQuestionId = jal2.Id, Text = "Quick Sort", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666624-6666-6666-6666-666666666666"), QuizQuestionId = jal2.Id, Text = "Insertion Sort", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jal3 = new QuizQuestion { Id = Guid.Parse("a9666663-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What is a base case in recursion?", Difficulty = "Easy", OrderNumber = 3, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jal3);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa666631-6666-6666-6666-666666666666"), QuizQuestionId = jal3.Id, Text = "The first call to the recursive method", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666632-6666-6666-6666-666666666666"), QuizQuestionId = jal3.Id, Text = "The condition that stops recursion", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666633-6666-6666-6666-666666666666"), QuizQuestionId = jal3.Id, Text = "The loop inside the recursive method", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666634-6666-6666-6666-666666666666"), QuizQuestionId = jal3.Id, Text = "The return type of the method", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jal4 = new QuizQuestion { Id = Guid.Parse("a9666664-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What data structure uses LIFO (Last In, First Out) order?", Difficulty = "Easy", OrderNumber = 4, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jal4);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa666641-6666-6666-6666-666666666666"), QuizQuestionId = jal4.Id, Text = "Queue", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666642-6666-6666-6666-666666666666"), QuizQuestionId = jal4.Id, Text = "Stack", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666643-6666-6666-6666-666666666666"), QuizQuestionId = jal4.Id, Text = "ArrayList", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666644-6666-6666-6666-666666666666"), QuizQuestionId = jal4.Id, Text = "LinkedList", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });

                var jal5 = new QuizQuestion { Id = Guid.Parse("a9666665-6666-6666-6666-666666666666"), QuizId = quiz6Id, Text = "What is the space complexity of merge sort?", Difficulty = "Hard", OrderNumber = 5, CreatedAt = DateTime.UtcNow, IsDeleted = false };
                await context.QuizQuestions.AddAsync(jal5);
                await context.QuizAnswerOptions.AddRangeAsync(new[]
                {
                    new QuizAnswerOption { Id = Guid.Parse("aa666651-6666-6666-6666-666666666666"), QuizQuestionId = jal5.Id, Text = "O(1)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666652-6666-6666-6666-666666666666"), QuizQuestionId = jal5.Id, Text = "O(log n)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666653-6666-6666-6666-666666666666"), QuizQuestionId = jal5.Id, Text = "O(n)", IsCorrect = true, CreatedAt = DateTime.UtcNow, IsDeleted = false },
                    new QuizAnswerOption { Id = Guid.Parse("aa666654-6666-6666-6666-666666666666"), QuizQuestionId = jal5.Id, Text = "O(n²)", IsCorrect = false, CreatedAt = DateTime.UtcNow, IsDeleted = false }
                });
