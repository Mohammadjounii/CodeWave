...
switch (day) {
  ...
  <p class=""text-slate-200"">Write a program that asks for an integer (0–23) and prints if it's morning, afternoon, evening or night.</p>
</div>",
...
do {
  ...
  <h3 class=""text-lg font-semibold mt-4 mb-2 text-slate-100"">Loop Exercise</h3>
  <p class=""text-slate-200"">Given an array of integers, compute the sum and average using a <code class=""bg-slate-900/70 px-1 rounded text-xs"">for</code> loop.</p>
</div>",
  ...
  <p class=""text-slate-200"">This mirrors a tiny version of what CodeWave does behind the scenes!</p>
            ...
            var exercises = new List<CodingExercise>
            {
                ...
                new CodingExercise
                {
                    ...
                    StarterCode = "public class Main {\n    public static void main(String[] args) {\n        // JVM stands for Java Virtual Machine\n        // It runs Java bytecode and makes Java platform-independent\n        // Bytecode is compiled Java code that runs on any device with JVM\n    }\n}\n",
                ...
                new CodingExercise
                {
                    ...
                    Description = "Change the message so it prints your name and your goal in learning Java.",
                    StarterCode = "public class Main {\n    public static void main(String[] args) {\n        String name = \"Your Name\";\n        String goal = \"become a Java developer\";\n        System.out.println(\"Hello, my name is \" + name + \" and I want to \" + goal);\n    }\n}\n",
                    ExpectedOutput = "Hello, my name is ... and I want to ..."
                },
                ...
                new CodingExercise
                {
                    ...
                    Description = "This program has a few syntax errors. Fix them so it compiles and runs.",
                    StarterCode =
"public class Main {\n" +
"    public static void main(String[] args) {\n" +
...
"}\n",
                ...
                new CodingExercise
                {
                    ...
                    Description = "Use variables for name, age and favorite language, then print them.",
                    StarterCode =
"public class Main {\n" +
"    public static void main(String[] args) {\n" +
"        String name = \"Tima\";\n" +
...
"        System.out.println(name + \" is \" + age + \" and loves \" + language + \".\");\n" +
"    }\n" +
"}\n",
                    ExpectedOutput = "Example: Tima is 20 and loves Java."
                },
                ...
                new CodingExercise
                {
                    ...
                    Description = "Read weight (kg) and height (m) from input, compute the BMI and print it formatted to 2 decimal places.",
                    StarterCode =
...
"public class Main {\n" +
"    public static void main(String[] args) {\n" +
"        int day = 3; // 1=Mon, 2=Tue, 3=Wed, 4=Thu, 5=Fri, 6=Sat, 7=Sun\n" +
"        String dayName;\n" +
"        switch (day) {\n" +
...
"}\n",
        ...
        private static async Task SeedJavaExerciseTestCasesAsync(ApplicationDbContext context)
        {
            ...
            // Exercise 2: Fix Compilation Error - Multiple test cases
            var exercise2Id = Guid.Parse("b2222222-2222-2222-2222-222222222222");
            var existingTestCases2 = await context.ExerciseTestCases
                .Where(tc => tc.ExerciseId == exercise2Id && !tc.IsDeleted)
                .AnyAsync();
            
            if (!existingTestCases2)
            {
                var testCases2 = new List<ExerciseTestCase>
                {
                    new ExerciseTestCase
                    {
                        ...
                        Input = "",
                        ExpectedOutput = "Hello World",
                        Description = "Test case 1: Should output 'Hello World' exactly",
                        OrderNumber = 1,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        ...
                        Description = "Test case 2: Should contain 'Hello'",
                        OrderNumber = 2,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    }
                };
                await context.ExerciseTestCases.AddRangeAsync(testCases2);
            }
            ...
            // Exercise 4: Grade Calculator - Multiple test cases
            var exercise4Id = Guid.Parse("b4444444-4444-4444-4444-444444444441");
            var existingTestCases4 = await context.ExerciseTestCases
                .Where(tc => tc.ExerciseId == exercise4Id && !tc.IsDeleted)
                .AnyAsync();
            
            if (!existingTestCases4)
            {
                var testCases4 = new List<ExerciseTestCase>
                {
                    new ExerciseTestCase
                    {
                        ...
                        Input = "73",
                        ExpectedOutput = "C",
                        Description = "Test case 1: Score 73 should output grade C",
                        OrderNumber = 1,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        ...
                        Input = "85",
                        ExpectedOutput = "B",
                        Description = "Test case 2: Score 85 should output grade B",
                        OrderNumber = 2,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a4444444-4444-4444-4444-444444444443"),
                        ExerciseId = exercise4Id,
                        Input = "95",
                        ExpectedOutput = "A",
                        Description = "Test case 3: Score 95 should output grade A",
                        OrderNumber = 3,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    }
                };
                await context.ExerciseTestCases.AddRangeAsync(testCases4);
            }
            else
            {
                // Fix existing records that were seeded with key=value input format
                var gtc1 = await context.ExerciseTestCases.FindAsync(Guid.Parse("a4444444-4444-4444-4444-444444444441"));
                if (gtc1 != null && gtc1.Input != "73") gtc1.Input = "73";
                var gtc2 = await context.ExerciseTestCases.FindAsync(Guid.Parse("a4444444-4444-4444-4444-444444444442"));
                if (gtc2 != null && gtc2.Input != "85") gtc2.Input = "85";
                var gtc3 = await context.ExerciseTestCases.FindAsync(Guid.Parse("a4444444-4444-4444-4444-444444444443"));
                if (gtc3 != null && gtc3.Input != "95") gtc3.Input = "95";
            }

            // Exercise 5: Sum of Array - Multiple test cases
            var exercise5Id = Guid.Parse("b5555555-5555-5555-5555-555555555551");
            var existingTestCases5 = await context.ExerciseTestCases
                .Where(tc => tc.ExerciseId == exercise5Id && !tc.IsDeleted)
                .AnyAsync();
            
            if (!existingTestCases5)
            {
                var testCases5 = new List<ExerciseTestCase>
                {
                    new ExerciseTestCase
                    {
                        ...
                        Input = "",
                        ExpectedOutput = "150",
                        Description = "Test case 1: Sum should be 150",
                        OrderNumber = 1,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        ...
                        Input = "",
                        ExpectedOutput = "30",
                        Description = "Test case 2: Average should be 30",
                        OrderNumber = 2,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a5555555-5555-5555-5555-555555555553"),
                        ExerciseId = exercise5Id,
                        Input = "",
                        ExpectedOutput = "Sum",
                        Description = "Test case 3: Should output 'Sum' label",
                        OrderNumber = 3,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    }
                };
                await context.ExerciseTestCases.AddRangeAsync(testCases5);
            }

            // Exercise 6: Print Triangle - Multiple test cases
            var exercise6Id = Guid.Parse("b5555555-5555-5555-5555-555555555552");
            var existingTestCases6 = await context.ExerciseTestCases
                .Where(tc => tc.ExerciseId == exercise6Id && !tc.IsDeleted)
                .AnyAsync();
            
            if (!existingTestCases6)
            {
                var testCases6 = new List<ExerciseTestCase>
                {
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a5555555-5555-5555-5555-555555555561"),
                        ExerciseId = exercise6Id,
                        Input = "",
                        ExpectedOutput = "*",
                        Description = "Test case 1: First line should be a single asterisk",
                        OrderNumber = 1,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a5555555-5555-5555-5555-555555555562"),
                        ExerciseId = exercise6Id,
                        Input = "",
                        ExpectedOutput = "*****",
                        Description = "Test case 2: Last line should have 5 asterisks",
                        OrderNumber = 2,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a5555555-5555-5555-5555-555555555563"),
                        ExerciseId = exercise6Id,
                        Input = "",
                        ExpectedOutput = "**",
                        Description = "Test case 3: Second line should have 2 asterisks",
                        OrderNumber = 3,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    }
                };
                await context.ExerciseTestCases.AddRangeAsync(testCases6);
            }

            // Exercise 7: Greet Method & Overloading (Lesson 6)
            var exercise7Id = Guid.Parse("b6666666-6666-6666-6666-666666666661");
            var existingTestCases7 = await context.ExerciseTestCases
                .Where(tc => tc.ExerciseId == exercise7Id && !tc.IsDeleted)
                .AnyAsync();

            if (!existingTestCases7)
            {
                var testCases7 = new List<ExerciseTestCase>
                {
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a6666666-6666-6666-6666-666666666661"),
                        ExerciseId = exercise7Id,
                        Input = "",
                        ExpectedOutput = "Hello, Alice!",
                        Description = "Test case 1: greet(\"Alice\") should print \"Hello, Alice!\"",
                        OrderNumber = 1,
                        CreatedAt = DateTime.UtcNow,
                        IsDeleted = false
                    },
                    new ExerciseTestCase
                    {
                        Id = Guid.Parse("a6666666-6666-6666-6666-666666666662"),
                        ExerciseId = exercise7Id,
                        Input = "",
                ...
                await context.ExerciseTestCases.AddRangeAsync(testCases7);
            }
