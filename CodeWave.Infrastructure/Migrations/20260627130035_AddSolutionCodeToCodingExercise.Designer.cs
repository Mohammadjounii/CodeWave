...
namespace CodeWave.Infrastructure.Migrations
{
    ...
    [Migration("20260627130035_AddSolutionCodeToCodingExercise")]
    partial class AddSolutionCodeToCodingExercise
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.Achievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.ExternalJobApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExternalJobApplications");
                });

            modelBuilder.Entity("CodeWave.Domain.Entities.InterviewQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.UserAchievement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.UserInterviewPractice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserInterviewPractices");
                });
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.UserReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.UserAchievement", b =>
                {
                    b.HasOne("CodeWave.Domain.Entities.Achievement", "Achievement")
            ...
            modelBuilder.Entity("CodeWave.Domain.Entities.UserInterviewPractice", b =>
                {
                    b.HasOne("CodeWave.Domain.Entities.InterviewQuestion", "Question")
                        .WithMany("Practices")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
