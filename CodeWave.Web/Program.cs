...
builder.Services.AddScoped<CodeWave.Application.Interfaces.IAchievementService, CodeWave.Infrastructure.Services.AchievementService>();
builder.Services.AddScoped<CodeWave.Application.Interfaces.IInterviewService, CodeWave.Infrastructure.Services.InterviewService>();
builder.Services.AddScoped<CodeWave.Application.Interfaces.ISearchService, CodeWave.Infrastructure.Services.SearchService>();
builder.Services.AddScoped<CodeWave.Application.Interfaces.IUserReportService, CodeWave.Infrastructure.Services.UserReportService>();
builder.Services.AddScoped<CodeWave.Application.Interfaces.IEmailService, CodeWave.Infrastructure.Services.EmailService>();
builder.Services.AddHttpClient<CodeWave.Application.Interfaces.IExternalJobService, CodeWave.Infrastructure.Services.ExternalJobService>();
builder.Services.AddScoped<CodeWave.Application.Interfaces.IExternalJobApplicationService, CodeWave.Infrastructure.Services.ExternalJobApplicationService>();
...
try
{
    using (var scope = app.Services.CreateScope())
    {
        ...
        await WebSeed.SeedAsync(context);
        await JobOfferSeed.SeedAsync(context);
        await AchievementSeed.SeedAsync(context);
        await InterviewSeed.SeedAsync(context);
    }
